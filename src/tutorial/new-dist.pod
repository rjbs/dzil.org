...
It's B<crucial> that you understand what's in that
"L<@Basic|Dist::Zilla::PluginBundle::Basic/DESCRIPTION>" bundle.  That is
...
The F<dist.ini> file, by the way, is an L<INI
file|https://en.wikipedia.org/wiki/INI_file>, following the L<grammar in
Config::INI|https://metacpan.org/pod/Config::INI#GRAMMAR>.
