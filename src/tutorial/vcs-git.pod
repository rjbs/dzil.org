...
Git repository is as easy as adding one line to your configuration:
...
Dist::Zilla.  The Git plugin bundle is equivalent to:
...
make this work, it is I<critcial> that you ensure that the Git::Commit plugin
runs I<after> NextRelease.  Since they're both AfterRelease plugins, this just
means making sure that they're ordered properly in your configuraiton.
